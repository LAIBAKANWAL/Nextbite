...
const ProductSection = ({
  ...
  if (!products || products.length === 0) {
    return (
      <section
        className="py-5"
        style={{ backgroundColor: "#82ae46", minHeight: "300px" }}
      >
        <div className="container">
          <h2 className="text-white fw-semibold fs-2 mb-4">{categoryName}</h2>
          <div
            ...
            >
              ...
              >
                ...
                <div className="card-body p-3 d-flex flex-column">
                        ...
                        {getOptionButtons(product).map((option) => {
                          ...
                          return (
                            <button
                              ...
                              style={{
                                backgroundColor: isSelected ? "#82ae46" : "",
                  ...
                  {/* Add to Cart Button */}
                  <button
                    className="btn w-100 mt-auto fw-semibold text-uppercase text-white"
                    style={{
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.target.style.boxShadow =
                        "0 4px 12px rgba(130,174,70,0.3)";
                    }}
                    onMouseLeave={(e) => {
